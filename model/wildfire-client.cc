  ...
  if (m_dataSize)
    {
      ...
      //
      NS_ASSERT_MSG (m_dataSize == m_size, "WildfireClient::Send(): m_size and m_dataSize inconsistent");
      NS_ASSERT_MSG (m_data, "WildfireClient::Send(): m_dataSize but no m_data");
